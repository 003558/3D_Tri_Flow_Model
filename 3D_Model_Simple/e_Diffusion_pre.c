 ...
 )
{
  ...
  for(l=0;l<nol;l++){
    for(n=0;n<noe;n++){
  	...
  	if(suG_h[ceC_h[n].su[e]].bd[l]==0){
  	  ...
  	  dq[e]=ceR_h[ceC_h[n].ce[e]].e[l]-ceR_h[n].e[l];
  	}
      }
    ...
    for(n=0;n<noe;n++){
      ...
      for(e=0;e<3;e++){
  	if(suG_h[ceC_h[n].su[e]].bd[l]==0){
  	  dqx[e]=((DATA_TYPE)0.0);//-((DATA_TYPE)2.0)*ceR_h[n].Eh[l]/S_e*ceR_h[n].qx[l];
  	  dqy[e]=((DATA_TYPE)0.0);//-((DATA_TYPE)2.0)*ceR_h[n].Eh[l]/S_e*ceR_h[n].qy[l];
  	}
  	else{
  	  dqx[e]=((DATA_TYPE)0.5)*(ceR_h[ceC_h[n].ce[e]].Eh[l]+ceR_h[n].Eh[l])/S_e*(ceR_h[ceC_h[n].ce[e]].qx[l]-ceR_h[n].qx[l]);
  	  dqy[e]=((DATA_TYPE)0.5)*(ceR_h[ceC_h[n].ce[e]].Eh[l]+ceR_h[n].Eh[l])/S_e*(ceR_h[ceC_h[n].ce[e]].qy[l]-ceR_h[n].qy[l]);
  	}
      }
  ...
  for(n=0;n<noe;n++){
    if(ceG_h[n].ns>=nol-2){
      ceR_h[n].e_Dif[nol-1]=((DATA_TYPE)0.0);
    }
    else{
      for(l=ceG_h[n].ns+1;l<nol-1;l++){
  	Ev1=((DATA_TYPE)0.5)*(ceR_h[n].Ev[l+1]+ceR_h[n].Ev[l])/S_e;
  	Ev2=((DATA_TYPE)0.5)*(ceR_h[n].e[l]+ceR_h[n].e[l-1])/S_e;
  	dq1=ceR_h[n].e[l+1]-ceR_h[n].e[l];
  	dq2=ceR_h[n].e[l]-ceR_h[n].e[l-1];
  	dz1=((DATA_TYPE)0.5)*(ceG_h[n].dz[l+1]+ceG_h[n].dz[l]);
  	dz2=((DATA_TYPE)0.5)*(ceG_h[n].dz[l]+ceG_h[n].dz[l-1]);
	
  	ceR_h[n].e_Dif[l]+=(Ev1*dq1/dz1-Ev2*dq2/dz2)/ceG_h[n].dz[l];
  	//ceR_h[n].e_Dif[l]=(Ev1*dq1/dz1-Ev2*dq2/dz2)/ceG_h[n].dz[l];
      }
      ...
      ceR_h[n].e_Dif[l]+=(Ev1*dq1/dz1-((DATA_TYPE)0.0))/ceG_h[n].dz[l];
      //ceR_h[n].e_Dif[l]=(Ev1*dq1/dz1-((DATA_TYPE)0.0))/ceG_h[n].dz[l];
      
      //surface
      l=nol-1;
      Ev2=((DATA_TYPE)0.5)*(ceR_h[n].Ev[l]+ceR_h[n].Ev[l-1])/S_e;
      dq2=ceR_h[n].e[l]-ceR_h[n].e[l-1];
      dz2=((DATA_TYPE)0.5)*(ceG_h[n].dz[l]+ceG_h[n].dz[l-1]);
      
      ceR_h[n].e_Dif[l]+=(((DATA_TYPE)0.0)-Ev2*dq2/dz2)/ceG_h[n].dz[l];
      //ceR_h[n].e_Dif[l]=(((DATA_TYPE)0.0)-Ev2*dq2/dz2)/ceG_h[n].dz[l];
    }
  }

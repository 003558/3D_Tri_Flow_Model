 ...
 )
{
  ...
  for(l=0;l<nol;l++){
	...
	dq=ceR_h[suC_h[n].ce[1]].e[l]-ceR_h[suC_h[n].ce[1]].e[l];
      }
    ...
    for(n=0;n<noe;n++){
      ...
      for(e=0;e<3;e++){
	dqx[e]=((DATA_TYPE)0.5)*(ceR_h[ceC_h[n].ce[e]].Eh[l]+ceR_h[n].Eh[l])/S_e*suR_h[ceC_h[n].su[e]].dqx;
	dqy[e]=((DATA_TYPE)0.5)*(ceR_h[ceC_h[n].ce[e]].Eh[l]+ceR_h[n].Eh[l])/S_e*suR_h[ceC_h[n].su[e]].dqy;
      }

 ...
 )
{
  ...
  for(l=0;l<nol;l++){
	...
	dq=ceR_h[suC_h[n].ce[1]].s[l]-ceR_h[suC_h[n].ce[1]].s[l];
      }
    ...
    for(n=0;n<noe;n++){
      ...
      for(e=0;e<3;e++){
	dqx[e]=((DATA_TYPE)0.5)*(ceR_h[ceC_h[n].ce[e]].Eh[l]+ceR_h[n].Eh[l])/S_r*suR_h[ceC_h[n].su[e]].dqx;
	dqy[e]=((DATA_TYPE)0.5)*(ceR_h[ceC_h[n].ce[e]].Eh[l]+ceR_h[n].Eh[l])/S_r*suR_h[ceC_h[n].su[e]].dqy;
      }
  ...
  for(n=0;n<noe;n++){
    if(ceG_h[n].ns>=nol-2){
      ceR_h[n].s_Dif[nol-1]=((DATA_TYPE)0.0);
    }
    else{
    for(l=ceG_h[n].ns+1;l<nol-1;l++){
      Ev1=((DATA_TYPE)0.5)*(ceR_h[n].Ev[l+1]+ceR_h[n].Ev[l])/S_r;
      Ev2=((DATA_TYPE)0.5)*(ceR_h[n].Ev[l]+ceR_h[n].Ev[l-1])/S_r;
      dq1=ceR_h[n].s[l+1]-ceR_h[n].s[l];
      dq2=ceR_h[n].s[l]-ceR_h[n].s[l-1];
      dz1=((DATA_TYPE)0.5)*(ceG_h[n].dz[l+1]+ceG_h[n].dz[l]);
      dz2=((DATA_TYPE)0.5)*(ceG_h[n].dz[l]+ceG_h[n].dz[l-1]);

      ceR_h[n].s_Dif[l]+=(Ev1*dq1/dz1-Ev2*dq2/dz2)/ceG_h[n].dz[l];
  	//ceR_h[n].s_Dif[l]=(Ev1*dq1/dz1-Ev2*dq2/dz2)/ceG_h[n].dz[l];
    }
    ...
    ceR_h[n].s_Dif[l]+=(Ev1*dq1/dz1-((DATA_TYPE)0.0))/ceG_h[n].dz[l];
      //ceR_h[n].s_Dif[l]=(Ev1*dq1/dz1-((DATA_TYPE)0.0))/ceG_h[n].dz[l];
    ...
    ceR_h[n].s_Dif[l]+=(((DATA_TYPE)0.0)-Ev2*dq2/dz2)/ceG_h[n].dz[l];
      //ceR_h[n].s_Dif[l]=(((DATA_TYPE)0.0)-Ev2*dq2/dz2)/ceG_h[n].dz[l];
    }
  }
